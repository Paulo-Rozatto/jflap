...
/**
 * The Automaton checker can be used to determine certain properties about automata.
 *
...
public class AutomatonChecker {
  ...
  /**
   * Returns true if <CODE>automaton</CODE> is a non-deterministic finite state automaton.
   *
   * @param automaton the automaton.
   * @return true if <CODE>automaton</CODE> is a non-deterministic finite state automaton.
   */
