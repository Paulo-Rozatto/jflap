...
/**
 * This lambda checker factory returns a lambda transition checker for the type of automaton passed
 * in.
 *
...
public class LambdaCheckerFactory {
  /**
   * Returns the lambda transition checker for the type of automaton that <CODE>automaton</CODE> is.
   *
   * @param automaton the automaton to get the checker for
   * @return the lambda transition checker for the type of automaton that <CODE>automaton</CODE> is
   *     or <CODE>null</CODE> if there is no lambda transition checker for this type of automaton
   */
