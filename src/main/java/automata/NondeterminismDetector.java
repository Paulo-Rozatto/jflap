...
/**
 * The nondeterminism detector object can be used to find all the nondeterministic states in an
...
public abstract class NondeterminismDetector {
  ...
  /**
   * Returns true if the transitions are identical (i.e. all components of the label are equivalent)
   * or if the transitions introduce nondeterminism
   *
