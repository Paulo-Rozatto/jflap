...
/**
 * The <CODE>NondeterminismDetectorFactory</CODE> is a factory class for returning a <CODE>
 * NondeterminismDetector</CODE> based on the automaton that is passed in.
 *
...
public class NondeterminismDetectorFactory {
   ...
   * @return the appropriate automaton simulator for this automaton, or <CODE>null</CODE> if there
   *     is no automaton simulator known for this type of automaton
   */
