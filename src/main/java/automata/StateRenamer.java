...
/**
 * This class contains operations to contain that all states have numeric IDs from 0 up. This will
 * change the ID numbers of the states.
 *
 * @author Thomas Finley
 */
public class StateRenamer {
  /**
   * Renames the states for an automaton, by changing all the ID numbers so that all the ID numbers
   * go from 0 up without interruption in the numeric sequence. This will modify the automaton
   * passed in.
   *
