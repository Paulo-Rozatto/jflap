...
/**
 * An <CODE>FSAConfiguration</CODE> object is a <CODE>Configuration</CODE> object with an additional
 * field for the input string. The current state of the automaton and the unprocessed input are the
 * only necessary data for the simulation of an FSA.
 *
...
public class FSAConfiguration extends Configuration {
   ...
   *
   * @param input the string that will represent the unprocessed input of the FSA.
   */
  ...
  /**
   * Checks for equality. Two FSAConfigurations are equal if they have the same unprocessed input,
   * and satisfy the .equals() test of the base <CODE>Configuration</CODE> class.
   *
