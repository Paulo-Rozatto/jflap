...
/**
 * The FSA label handler is an object that can convert a finite state automaton with transition
 * labels of more than one character in length into an equivalent finite state automaton with all
...
public class FSALabelHandler {
  ...
  /**
   * Returns true if <CODE>automaton</CODE> has labels with multiple characters, instead of single
   * character labels.
   *
   * @param automaton the automaton.
   * @return true if <CODE>automaton</CODE> has labels with multiple characters, instead of single
   *     character labels.
   */
  ...
  /**
   * Changes <CODE>transition</CODE> in <CODE>automaton</CODE> to several transitions each with
   * labels of one character in length. This algorithm introduces new states in <CODE>automaton
   * </CODE>.
   *
   * @param transition the transition to break up into several transitions of one character (in
   *     length) a piece.
  ...
  /**
   * Changes all transitions in <CODE>automaton</CODE> into transitions with at most one character
   * per label. This could introduce more states into <CODE>automaton</CODE>.
   *
   * @param automaton the automaton.
   */
