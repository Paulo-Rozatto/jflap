...
/**
 * The FSA nondeterminism detector object can be used to find all the nondeterministic states in a
 * finite state automaton (i.e. all states with equal outward transitions).
 *
...
public class FSANondeterminismDetector extends NondeterminismDetector {
  ...
  /**
   * Returns true if the transitions are identical (i.e. the labels are equivalent), or if they
   * introduce nondeterminism (e.g. the label of one could be a prefix of the label of the other).
   *
