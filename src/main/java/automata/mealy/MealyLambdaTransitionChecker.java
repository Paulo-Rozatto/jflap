...
/**
 * The <code>MealyLambdaTransitionChecker</code> can be used to determine if a Mealy or Moore
...
public class MealyLambdaTransitionChecker extends LambdaTransitionChecker {
  ...
  /**
   * Returns <code>true</code> if <code>transition</code> is a lambda transition (i.e. its label is
   * the lambda string).
   *
   * @param transition the transtion
   * @return <code>true</code> if the transition is a lambday transition, <code>false</code>
   *     otherwise
   */
