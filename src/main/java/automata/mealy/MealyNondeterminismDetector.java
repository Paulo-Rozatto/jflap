...
/**
 * The <code>MealyNondeterminismDetector</code> can be used to find all the nondeterministic states
 * in a Mealy or Moore machine (all states with equal outward transitions).
 *
 * @author Jinghui Lim
 */
public class MealyNondeterminismDetector extends NondeterminismDetector {
  ...
  /**
   * Returns true if the transitions are identical (the labels are equivalent), or if they introduce
   * nondeterminism (for example, the label of one could be a prefix of the label of the other).
   *
