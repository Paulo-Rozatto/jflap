...
/**
 * This subclass of <CODE>Automaton</CODE> is specifically for a variable dependency graph used in
 * the transformation of grammars (e.g. removing unit productions).
 *
