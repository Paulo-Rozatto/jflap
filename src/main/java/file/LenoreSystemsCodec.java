...
/**
 * This is the codec for reading JFLAP structures in the Lenore-Systems format, making any
 * conversions necessary between the two formats. Lenore-Systems is my name for the L-systems tool
 * developed at Duke by Lenore Ramm. Its real name is Lsys, and was never widely distributed.
 *
 * @author Thomas Finley
 */
public class LenoreSystemsCodec extends Codec {
  /**
   * Given a file, this will return an L-system associated with that file. This method should always
   * return a structure, or throw a {@link ParseException} in the event of failure with a message
   ...
   * @return a JFLAP structure resulting from the interpretation of the Lenore-Systems file
