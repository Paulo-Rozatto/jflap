...
/**
 * This is the codec for reading and writing JFLAP structures as serialized objects.
 *
...
public class SerializedCodec extends Codec {
  ...
  /**
   * Instantiates a new serialized codec. Serialization as a saving method is now deprecated. The
   * new method is XML, so when opening a file with a serialized codec the corresponding encoder is
   * actually a {@link XMLCodec}.
   *
  ...
  /**
   * Given a file, this will return a JFLAP structure associated with that file. This method should
   * always return a structure, or throw a {@link ParseException} in the event of failure with a
   * message detailing the nature of why the decoder failed.
   *
  ...
  /**
   * Given a structure, this will attempt to write the structure as a serialized object to a file.
   *
