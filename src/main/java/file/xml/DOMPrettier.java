...
/**
 * This prettier converts DOMs to a prettier form. When creating a new raw DOM, all the tags run
 * together. However, this is not very pretty. To correct this, text tags are inserted every so
 * often to create at most one element per line, where everything is properly indented, just as one
 * would see in an XML document formated by hand.
 *
 * @author Thomas Finley
 */
public class DOMPrettier {
  /**
   * The changing indentation string. Whenever a new level of indent is reached, this is prepended.
   */
  ...
  /**
   * Pretty-fies a DOM by inserting whitespace text nodes at appropriate places. This modifies the
   * DOM itself.
   *
