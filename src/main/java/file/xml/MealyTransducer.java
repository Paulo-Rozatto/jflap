...
/**
 * This is the transducer for encoding and decoding {@link automata.mealy.MealyMachine} objects.
 *
 * @author Jinghui Lim
 */
public class MealyTransducer extends AutomatonTransducer {
   ...
   * @param node the DOM node corresponding to the transition, which should contain a "read"
   *     element, a "pop" element, and a "push" elements
  ...
  /**
   * Produces a DOM element that encodes a given transition. This adds the strings to read and the
   * output.
   *
