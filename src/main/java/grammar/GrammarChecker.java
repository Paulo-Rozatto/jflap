...
/**
 * The Grammar checker object can be used to check certain properties of grammar objects.
 *
...
public class GrammarChecker {
  ...
  /**
   * Returns true if <CODE>grammar</CODE> is a regular grammar (i.e. if it is either a right or left
   * linear grammar).
   *
  ...
  /**
   * Returns true if <CODE>grammar</CODE> is a right-linear grammar (i.e. all productions are of the
   * form A->xB or A->x).
   *
   * @param grammar the grammar.
  ...
  /**
   * Returns true if <CODE>grammar</CODE> is a left-linear grammar (i.e. all productions are of the
   * form A->Bx or A->x).
   *
   * @param grammar the grammar.
  ...
  /**
   * Returns true if <CODE>grammar</CODE> is a context-free grammar (i.e. all productions are of the
   * form A->x).
   *
   * @param grammar the grammar.
  ...
  /**
   * Returns true if <CODE>variable</CODE> is in any production, either on the right or left hand
   * side of the production, of <CODE>grammar</CODE>.
   *
  ...
  /**
   * Returns true if <CODE>terminal</CODE> is in any production, either on the right or left hand
   * side of the production, of <CODE>grammar</CODE>.
   *
  ...
  /**
   * Returns all productions in <CODE>grammar</CODE> that have <CODE>variable</CODE> as the only
   * character on the left hand side and that are not unit productions.
   *
   * @param variable the variable
   * @param grammar the grammar
   * @return all productions in <CODE>grammar</CODE> that have <CODE>variable</CODE> as the only
   *     character on the left hand side and are not unit productions.
   */
  ...
  /**
   * Returns true if <CODE>production</CODE>, or an identical production, is already in <CODE>
   * grammar</CODE>.
   *
   * @param production the production
   * @param grammar the grammar
   * @return true if <CODE>production</CODE>, or an identical production, is already in <CODE>
   *     grammar</CODE>.
   */
  ...
  /**
   * Returns all productions in <CODE>grammar</CODE> that have <CODE>variable</CODE> in them, either
   * on the rhs or lhs.
   *
   * @param variable the variable
   * @param grammar the grammar
   * @return all productions in <CODE>grammar</CODE> that have <CODE>variable</CODE> in them, either
   *     on the rhs or lhs.
   */
  ...
  /**
   * Returns all productions in <CODE>grammar</CODE> that have <CODE>variable</CODE> on the right
   * hand side.
   *
   * @param variable the variable
   * @param grammar the grammar
   * @return all productions in <CODE>grammar</CODE> that have <CODE>variable</CODE> on the right
   *     hand side.
   */
  ...
  /**
   * Returns a list of those variables which are unresolved, i.e., which appears in the right hand
   * side but do not appear in the left hand side.
   *
