...
/**
 * The Production checker object can be used to check certain properties of production objects.
 *
...
public class ProductionChecker {
  ...
  /**
   * Returns true if <CODE>production</CODE> is linear (i.e. either right or left linear).
   *
  ...
  /**
   * Returns true if <CODE>production</CODE> is a production of the form A->Bx where x is a series
   * of 0 or more terminals
   *
   * @param production the production
   * @return true if <CODE>production</CODE> is a production of the form A->Bx where x is a series
   *     of 0 or more terminals
   */
  ...
  /**
   * Returns true if <CODE>production</CODE> is a production of the form A->xB where x is a series
   * of 0 or more terminals
   *
   * @param production the production
   * @return true if <CODE>production</CODE> is a production of the form A->xB where x is a series
   *     of 0 or more terminals
   */
  ...
  /**
   * Returns true if <CODE>production</CODE> is a production of the form A->x where x is a series of
   * 0 or more terminals.
   *
   * @param production the production
   * @return true if <CODE>production</CODE> is a production of the form A->x where x is a series of
   *     0 or more terminals.
   */
  ...
  /**
   * Returns true if the left hand side of <CODE>production</CODE> is a single variable.
   *
   * @param production the production.
   * @return true if the left hand side of <CODE>production</CODE> is a single variable.
   */
  ...
  /**
   * Returns true if <CODE>variable</CODE> is in the production, either on the right or left hand
  ...
  /**
   * Returns true if <CODE>terminal</CODE> is in the production, either on the right or left hand
   * side of the production.
   *
  ...
  /**
   * Returns true if <CODE>ch</CODE> is a variable. A variable is determined to be any uppercase
   * character.
   *
  ...
  /**
   * Returns true if <CODE>ch</CODE> is a terminal. A terminal is determined to be any lowercase
   * character.
   *
   * @param ch the character being checked.
  ...
  /**
   * Returns true if <CODE>variable</CODE> is on the right hand side of <CODE>production</CODE>.
   *
   * @param production the production
   * @param variable the variable
   * @return true if <CODE>variable</CODE> is on the right hand side of <CODE>production</CODE>.
   */
