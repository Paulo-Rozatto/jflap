...
/**
 * This is a comparator for productions that sorts productions lexigraphically, with the exception
 * that the start variable is always ordered first on the LHS.
 *
...
public class ProductionComparator implements Comparator<Object> {
  ...
  /**
   * Instantiates a comparator, getting the start variable from a given grammar.
   *
  ...
  /**
   * Instantiates a comparator, with the start variable is passed in explicitly.
   *
  ...
  /**
   * Two production comparators are equal if they have the same start variable.
   *
