...
/**
 * An unbound grammar has no restrictions whatsoever in the way of what productions can be added to
 * it. Since we may no longer depend on the first production being restricted, the start variable is
