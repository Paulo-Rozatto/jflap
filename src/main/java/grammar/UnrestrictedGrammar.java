...
/**
 * The unrestricted grammar is a grammar that can have any production added to it, save for the
 * initial production, which must be restricted since the first production specifies the initial
 * variable in JFLAP.
 *
...
public class UnrestrictedGrammar extends Grammar {
  ...
  /**
   * Every production is all right except those with lambda in the left hand side of the production.
   *
   ...
   * @throws IllegalArgumentException if the first production added is unrestricted on the left hand
   *     side
   */
