...
/**
 * The context free grammar object is a representation of a context free grammar. This object is a
 * data structure of sorts, maintaining the data pertinent to the definition of a context free
 * grammar.
 *
...
public class ContextFreeGrammar extends Grammar {
  ...
  /**
   * Creates an instance of <CODE>ContextFreeGrammar</CODE>. The created instance has no
   * productions, no terminals, no variables, and specifically no start variable.
   */
  ...
  /**
   * Throws an exception if the production is unrestricted on the left hand side.
   *
