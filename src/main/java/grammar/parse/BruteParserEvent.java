...
/**
 * This is an event that is thrown from a brute parser whenever it starts, pauses, accepts, or
 * rejects a string.
 *
...
public class BruteParserEvent extends EventObject {
  ...
  /**
   * Returns true if this event indicates the start (or resumption) of parsing.
   *
