...
/**
 * The regular grammar object is a representation of a regular grammar. This object is a data
 * structure of sorts, maintaining the data pertinent to the definition of a regular grammar.
 *
...
public class RegularGrammar extends Grammar {
  ...
  /**
   * Creates an instance of <CODE>RegularGrammar</CODE>. The created instance has no productions, no
   * terminals, no variables, and specifically no start variable.
   */
  ...
  /**
   * Returns the linearity of the grammar in the form of an int. 0 means left-linear, 1 means
   * right-linear.
   *
  ...
  /**
   * Sets the linearity of the regular grammar to the value represented by <CODE>linearity</CODE>.
  ...
  /**
   * Adds a production to the grammar. After the production is added, this method also sets the
   * linearity of this grammar.
   *
