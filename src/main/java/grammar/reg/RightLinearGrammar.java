...
/**
 * This <CODE>RightLinearGrammar</CODE> is a regular grammar with the additional restriction that
 * the grammar cannot be a left linear grammar.
 *
...
public class RightLinearGrammar extends RegularGrammar {
  ...
  /**
   * The production checker makes sure that the production added is a proper right linear
   * production.
   *
