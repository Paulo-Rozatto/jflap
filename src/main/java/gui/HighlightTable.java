...
/**
 * This table allows the highlighting of specific cells in a <CODE>JTable</CODE>. This assumes that
 * highlighted cells will render just fine with a default cell renderer. Key methods used are {@link
 * #highlight(int, int)} and {@link #dehighlight(int, int)}, though there are variations of these
 * for added convinience, and other variations for added customizability of the highlighting (in
 * case highlighted cells will not render properly with a default cell renderer, for example).
 *
...
public class HighlightTable extends JTable {
  ...
  /**
   * This method is the highlight method but allows the specification of a custom table cell
   * renderer.
   *
   * @param rc the array of row and column entries, done in the model-space rather than view-space
   *     of the table
   * @param generator the generator of the cell renderers for this particular highlight
  ...
  /**
   * This method is the highlight method but allows the specification of a custom table cell
   * renderer. This will retain previous highlightings.
   *
   * @param row the row index of the cell to highlight
   * @param column the column index of the cell to highlight
   * @param generator the generator of the cell renderers for this particular highlight
  ...
  /** This class is used to get the cell renderer for a table highlighting action. */
  public interface TableHighlighterRendererGenerator {
     ...
     * @param column the model-space column index to get the table cell render for
