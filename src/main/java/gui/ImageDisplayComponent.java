...
/**
 * The <CODE>ImageDisplayComponent</CODE> is a single component that displays an image within
 * itself, and sets its size to match that of the image.
 *
...
public class ImageDisplayComponent extends JComponent implements Scrollable {
  ...
  /** Instantiates a new <CODE>ImageDisplayComponent</CODE> without an image at this time. */
  ...
  /**
   * Sets the image associated with this component, with (0,0) set as the origin.
   *
   * @param image the new image for this component
   */
   ...
   *
   * @param image the new image for this component
   * @param origin the point in the image that is the real "origin" of the image (should be 0,0 in
   *     most cases)
   */
   ...
   * @return <TT>true</TT> if the tracking succeeded, <TT>false</TT> if it was interrupted
   */
  ...
  /**
   * We want this view sized so that it is either larger than or just as wide as the containing
   * scroll pane.
   */
  ...
  /**
   * We want this view sized so that it is either larger than or just as tall as the containing
   * scroll pane.
   */
