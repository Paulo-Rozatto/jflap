...
/**
 * Handles uncaught exceptions and errors in the AWT thread. The goal of JFLAP's code is, of course,
 * to not have any uncaught exceptions at all. However, inevitably mistakes happen, and when they do
 * it is best if the users can be made to give information of somewhat better quality than "it
 * doesn't work!" This will bring up a dialog box with the stack trace and any other relevant
 * information.
 *
