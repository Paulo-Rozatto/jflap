...
public class VDGTransitionCreator extends TransitionCreator {
   ...
   *
   * @param parent the parent object that any dialogs or windows brought up by this creator should
   *     be the child of
   */
  ...
  /**
   * Edits a given transition. Ideally this should use the same interface as that given by <CODE>
   * createTransition</CODE>.
   *
   * @param transition the transition to edit
   * @return <CODE>false</CODE> if the user decided to not edit a transition, <CODE>true</CODE> if
