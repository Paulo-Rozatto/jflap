...
/**
 * This is a subclass of <code>ComputerFirstPane</code> that deals with context-free pumping lemmas.
 *
...
public class CompCFPumpingLemmaInputPane extends ComputerFirstPane {
  ...
  /**
   * Initializes the animation canvas with the values of <i>u</i>, <i>v</i>, <i>x</i>, <i>y</i>, and
   * <i>z</i>.
   */
  ...
  /**
   * Creates an HTML string <i>uv<sup>i</sup>xy<sup>i</sup>z</i>, with the real value of <i>i</i>
