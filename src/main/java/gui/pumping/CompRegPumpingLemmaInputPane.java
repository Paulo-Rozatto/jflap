...
/**
 * This is a subclass of <code>ComputerFirstPane</code> that deals with regular pumping lemmas.
 *
...
public class CompRegPumpingLemmaInputPane extends ComputerFirstPane {
  ...
  /** Initializes the animation canvas with the values of <i>x</i>, <i>y</i>, and <i>z</i>. */
  ...
  /**
   * Creates an HTML string <i>xy<sup>i</sup>z</i>, with the real value of <i>i</i> instead of the
   * variable <i>i</i>.
   *
