...
/**
 * A <code>Text</code> object is a <code>String</code> that contains information on how to paint
 * itself on a {@link gui.pumping.Canvas}.
 *
 * @author Jinghui Lim
...
public class Text {
  ...
  /** The position of the bottom left hand corner of this text on the <code>Canvas</code>. */
  ...
  /**
   * Constructs a <code>Text</code> object with an input string and a position.
   *
  ...
  /**
   * getgraphics Constructs a new <code>Text</code> object with the same fields as <code>t</code>.
   *
  ...
  /**
   * This returns a <code>Text</code> object that acts as a label to the give <code>Text</code>,
   * <code>text</code>.
   *
  ...
  /**
   * Returns the height of "b". Different letters return different heights, so we use the tallest
   * letter available to ensure we get the same kind of spacing.
   *
   * @param pen the <code>Graphics</code> this object will be painted with
