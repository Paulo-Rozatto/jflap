...
/**
 * The <CODE>ConfigurationSelectionEvent</CODE> is an event thrown by a <CODE>ConfigurationPane
 * </CODE> whenever a transition is selected or deselected in that pane. Because many transitions
 * may be selected or deselected at once, this merely registers that a change has happened without
