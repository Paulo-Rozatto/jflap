...
/**
 * This is a rather silly factory class that returns shape objects that look like "torn tape," for
 * objects that need to express a potentially very large structure in a very small amount of space.
 * These objects are here referred to often as "torn". I've nouned torn, like I just verbed noun.
 *
