 ...
 * {<i>w<sub>1</sub>cw<sub>2</sub>cw<sub>3</sub>cw<sub>4</sub></i>, : <i>w<sub>1</sub></i> =
 * <i>w<sub>2</sub></i> or <i>w<sub>3</sub></i> = <i>w<sub>4</sub></i>, <i>w<sub>i</sub></i> &#8712;
 * {<i>a</i>, <i>b</i>}*, |<i>w<sub>i</sub></i>| > 0}.
 *
 * @author Chris Morgan
 */
public class W1CW2CW3CW4 extends ContextFreePumpingLemma {
  ...
  /**
   * Will return a String[] containing all the w[k] values from w[0]...w[3] in the given string.
   *
