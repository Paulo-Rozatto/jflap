...
/**
 * The context-free pumping lemma for <i>L</i> = {<i>w<sub>1</sub>vv<sup>R</sup>w<sub>2</sub></i>, :
 * <i>n<sub>a</sub></i>(<i>w<sub>1</sub></i>) = <i>n<sub>a</sub></i>(<i>w<sub>2</sub></i>),
 * |<i>v</i>| &#8805; 3, <i>v</i>, <i>w<sub>1</sub></i>, & <i>w<sub>2</sub></i> &#8712; {<i>a</i>,
 * <i>b</i>}*}.
 *
 * @author Chris Morgan
 */
public class W1VVrW2 extends ContextFreePumpingLemma {
  ...
  /**
   * This method returns the first acceptable vv<sup>R</sup> segment that it can find.
   *
   * @param s the string in which to find the vv<sup>R</sup> segment.
   * @return the segment in an int[], with the first index of the segment of the given string in the
   *     first array item, and the last index in the second array item.
   */
